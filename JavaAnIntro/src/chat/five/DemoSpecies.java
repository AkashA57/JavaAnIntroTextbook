...
/**
This version of the class Species is only a toy example designed to demonstrate the difference between parameters of a class type and parameters of a primitive type.
*/
...
public void readInput()
{
    ...
    System.out.println(
"Enter growth rate (% increase per year):"); growthRate = keyboard.nextDouble();
}
...
public void tryToReplace(DemoSpecies otherObject) {
        otherObject = this;
        System.out.println("otherObject : " + otherObject);
    }
    /**
...
//<The rest of the class definition is the same as that of the class Species in Listing 5.19.>
}
